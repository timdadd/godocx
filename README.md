...
[![Go CI](https://godocx/actions/workflows/go.yml/badge.svg)](https://godocx/actions/workflows/go.yml) ![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/gomutex/godocx) [![Go Reference](https://pkg.go.dev/badge/godocx.svg)](https://pkg.go.dev/godocx)
 [![Go Report Card](https://goreportcard.com/badge/godocx)](https://goreportcard.com/report/godocx) [![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
...
In depth, go docs can be seen using go's built-in documentation tool, or online at [go.dev](https://pkg.go.dev/godocx). Please refer the [subpackage docx](https://pkg.go.dev/godocx/docx) for the list of functions that can be used.
...
![Screenshot of the demo output](https://godocx-examples/raw/main/demo.png)
